...
<main id="main">
    <div id="menu" class="buttons-container ">
        <div class="dropdown-alunos">
            <a class="alunos">
                Alunos
                <img src="<?php echo '/TCCheroku/assets/icons/alunosIcon.svg'; ?>" alt="Alunos ícone"/>
            </a>
            <div class="dropdown-content-alunos">
                <a href="<?php echo '/TCCheroku/Pages/FormAluno'; ?>">Cadastrar Alunos</a>
                <a href="<?php echo '/TCCheroku/Pages/ListaAluno'; ?>">Listagem Alunos</a>
            </div>
        </div>
    </div>
</main>
